    ...
    render(){
        return(
            <div className="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-company elementor-col-100 elementor-field-required">
                ...
                <input id={this.props.for} value={this.props.value} onChange={this.props.onChange} size="1" type="text" name={ this.props.fieldName } className="hq-inputs" placeholder={this.props.placeholder} required="required" aria-required="true" />
            </div>
        );
    }
}
