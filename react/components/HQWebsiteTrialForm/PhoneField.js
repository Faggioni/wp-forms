    ...
    render(){
        return(
            <div className="elementor-field-type-tel elementor-field-group elementor-column elementor-field-group-field_2 elementor-col-100 elementor-field-required">
                ...
                <input id={this.props.for} value={this.props.value} onChange={this.props.onChange} size="1" type="tel" name={this.props.nameField} className="hq-inputs" placeholder={this.props.placeholder} required="required" aria-required="true" title={this.props.title} />
            </div>
        );
    }
}
