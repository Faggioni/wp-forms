                ...
                this.connector.submitForm(
                    ...
                    (error) => {
                        if (error.response) {
                            ...
                            alert("There was an issue with your request. Please contact us on our chat to complete the trial setup process.");
                        } else {
                            // Something happened in setting up the request that triggered an Error
                            alert("There was an issue internally with your request. Please contact us on our chat to complete the trial setup process.");
                        }
                    });
            },
            (errors) => {
